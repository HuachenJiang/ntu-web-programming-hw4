...
- 本仓库第一阶段就应先建立 `frontend/.env`、`frontend/.env.example`、`backend/.env`、`backend/.env.example`
...
- `AGENTS.md`: 协作规范与实现约束
- `docs/achitecture.md`: 项目整体架构说明与模块分层
- `docs/google-maps-setup.md`: Google Maps 开通与配置说明

补充约定：

- `docs/` 文件夹专门放文档
- 架构优先写在 `docs/achitecture.md`
- Google Maps API 相关说明统一放在 `docs/` 下维护
